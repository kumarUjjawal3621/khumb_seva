          ...
          <div className="grid gap-10 md:grid-cols-[1.6fr_1fr_1fr_1.2fr]">
            ...
            <div>
              ...
              <div className="mt-5 flex items-center gap-3 flex-wrap">
                <a href="https://www.facebook.com/people/Nasik-Kumbhparv/61590559648365/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[var(--color-maroon)]/10 hover:bg-[var(--color-maroon)] text-[var(--color-maroon)]/60 hover:text-white flex items-center justify-center transition-all duration-200" aria-label="Facebook">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
                </a>
                <a href="https://www.instagram.com/nasikkumbhparv?igsh=MW5mM3l0OTg0MTZpcg==" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[var(--color-maroon)]/10 hover:bg-[var(--color-maroon)] text-[var(--color-maroon)]/60 hover:text-white flex items-center justify-center transition-all duration-200" aria-label="Instagram">
                ...
                <a href="https://x.com/nasikkumbhparv" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[var(--color-maroon)]/10 hover:bg-[var(--color-maroon)] text-[var(--color-maroon)]/60 hover:text-white flex items-center justify-center transition-all duration-200" aria-label="X (Twitter)">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <a href="https://www.youtube.com/@NasikKumbhparv" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[var(--color-maroon)]/10 hover:bg-[var(--color-maroon)] text-[var(--color-maroon)]/60 hover:text-white flex items-center justify-center transition-all duration-200" aria-label="YouTube">
            ...
            <div>
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="flex items-start gap-3 text-sm text-[var(--color-maroon)]/75">
                  ...
                  <span>nasikkumbhparv@gmail.com</span>
                </div>
              </div>
